...
<ul class="inline-flex items-center gap-6 px-5 py-3 my-6 mb-2 text-xs font-semibold tracking-wider text-black bg-white shadow rounded-3xl">
    <a href="{{route('posts-management')}}" class="relative nav active transition duration-300 ease-in-out hover:-translate-y-1 {{ request()->routeIs('events.index') ? 'text-red-500 ' : '' }}">
    ...
    <a href="{{route('posts-management')}}" class="relative nav active transition duration-300 ease-in-out hover:-translate-y-1 {{ request()->routeIs('events.index') ? 'text-red-500 ' : '' }}">
        <li class="font-bold capitalize">Condession of Sin</li>
        <div class="nav-underline"></div>
    </a>
    <a href="{{route('posts-management')}}" class="relative nav active transition duration-300 ease-in-out hover:-translate-y-1 {{ request()->routeIs('events.index') ? 'text-red-500 ' : '' }}">
