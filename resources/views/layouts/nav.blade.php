<div class = "fixed top-0 w-full z-30 flex bg-white dark:bg-[#0F172A] p-2 items-center justify-center h-16 gap-4 px-10">
    ...
    <div class = "flex items-center justify-center flex-none h-full text-center">
            ...
            <div class = "flex items-center px-3 space-x-3">
                ...
                <div class="flex w-8 h-8 ">
                    <img src="{{asset('img/profile.png')}}" alt="profile" class="object-cover rounded-full shadow" />
                </div>
                </div>

                <div class = "hidden text-sm text-black md:block md:text-md dark:text-white">Hello Philippian!</div>
            </div>
